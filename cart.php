                  ...
                  <div class="col-md-9" id="cart"><!-- col-md-9 Begin -->
                    ...
                    <div class="box"><!-- box Begin -->
                      ...
                      <form method="post" action="cart.php" enctype="multipart/form-data">
                        ...
                        <div class="tabel-responsive"><!-- tabel-responsive Begin -->
                          ...
                          <table class="table"><!-- table Begin -->
                            ...
                            <tbody>
                              <td>
                                ...
                                <img src="admin_area/product_images/Product-6a.jpg" alt="Product 3" class="img-responsive">
                        ...
                        <div class="box-footer"><!-- box-footer Begin -->
                          ...
                          <div class="pull-left"><!-- pull-left Begin -->
                            ...
                            <a href="index.php" class=" btn btn-default"><!-- btn btn-default Begin -->
                              ...
                              <i class="fa fa-chevron-left"> Contnue Shopping</i>
                          ...
                          <div class="pull-right"><!-- pull-right Begin -->
                            ...
                            <button type="submi" name="update" class= "btn btn-default"><!-- btn btn-default Begin -->
                  ...
                  <div class="col-md-3"><!-- col-md-3 Begin -->
                    ...
                    <div id="order-summary" class="box"><!-- box Begin -->
                      ...
                      <p class="text-muted"><!-- text-muted Begin -->
                        ...
                        Shipping and addtional costs are calculated based on value you have enterd
