...
<div class="row"><!-- row Begin -->
  ...
  <div class="col-lg-12"><!-- col-lg-12 Begin -->
      ...
      <form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Begin -->
        ...
        <div class="form-group"><!-- form-group Begin -->
          ...
          <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <select class="form-control" name="product_cat"><!-- form-control Begin -->
        ...
        <div class="form-group"><!-- form-group Begin -->
          ...
          <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <select class="form-control" name="cat"><!-- form-control Begin -->
        ...
        <div class="form-group"><!-- form-group Begin -->
          ...
          <div class="form-group"><!-- form-group Begin -->
            ...
            <div class="col-md-6"><!-- col-md-6 Begin -->
              ...
              <textarea name="product_desc" rows="16" cols="19" class="form-control"></textarea>
    ...
    <script srt="js/jquery-311.min.js"></script>
...
if(isset($_POST['submit'])){
  ...
  ,product_img2,product_img3,product_price,product_keywords,product_desc) values
  ('$product_cat','$cat',NOW(),'$product_title','$product_img1','$product_img2',
  '$product_img3','$product_price','$product_keywords','$product_desc')";
